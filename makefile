...
SOURCES = main.cpp SystemGenerator.cpp OS.cpp CPU.cpp MMU.cpp JobPool.cpp Device.cpp Printer.cpp Disk.cpp CD.cpp PCB.cpp PCBQueue.cpp ReadyQueue.cpp DiskQueue.cpp
